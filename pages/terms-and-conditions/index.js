    ...
    <Section style={'pt-32 pb-16 scroll-smooth'}>
      <Container style={'font-mulish'}>
        ...
        <p>
          ...
          materials on Wayland's Website for personal, non-commercial transitory
        ...
        <p>
          ...
          all other warranties. Furthermore, Wayland does not make any
        ...
        <p>
          Wayland or its suppliers will not be hold accountable for any damages
          that will arise with the use or inability to use the materials on
          Wayland’s Website, even if Wayland or an authorize representative of
        ...
        <p>
          ...
          current. Wayland may change the materials contained on its Website at
          any time without notice. Wayland does not make any commitment to
        ...
        <p>
          Wayland has not reviewed all of the sites linked to its Website and is
          not responsible for the contents of any such linked site. The presence
          of any link does not imply endorsement by Wayland of the site. The use
