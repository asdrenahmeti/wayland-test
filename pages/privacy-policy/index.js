...
function index() {
  return (
    <>
      <Head>
        <title> Wayland | Privacy Policy</title>
      ...
      <Section style={'pt-32 pb-16 scroll-smooth'}>
        <Container style={'font-mulish'}>
          ...
          <p>
            ...
            that they shared and/or collect in Wayland. This policy is not
          ...
          <p>
            Like any other website, Wayland uses 'cookies'. These cookies are
          ...
          <p>
            ...
            respective advertisements and links that appear on Wayland, which
          ...
          <p>
            Note that Wayland has no access to or control over these cookies
